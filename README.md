...
<br /><br /><br />      If ```fixed_decay == False```, the weight is multiplied by ``` 1 -lr x weight_decay``` <br>
<br /><br /><br />      If ```fixed_decay == True```, the weight is multiplied by ```1 - weight_decay``` 
